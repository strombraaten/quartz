...
Jo, for å tydeliggjøre [[stegene-av-et-notat|de ulike stegene]] fra inspirasjon (et sitat eller setning som resonnerer med deg) til du [[bruk-det-du-larer|bruker det du har lært]]. Siden det er flere ulike tilnærminger til det samme syns jeg det blir lettere å ta et isolert blikk på hver av dem. Derfor kommer jeg også til å gjøre det samme med [[zettelkasten|zettelkasten-metoden]] framover. Som i stor grad har vært med å påvirke hvordan jeg håndterer det jeg lærer, og måten jeg skriver på nå.
