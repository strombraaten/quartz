...
Det som imponerer meg er at når jeg vurderer [[obsidian|obsidian]] ut fra de kriteriene jeg nevnte, som er viktig for meg så huker den av absolutt alle boksene, og vel så det!
...
![[images/obsidian-hurtigtaster.png|images/obsidian-hurtigtaster.png]]
...
![[images/obsidian-release-notes.png|images/obsidian-release-notes.png]]
![[images/obsidian-release-notes-canvas.png|images/obsidian-release-notes-canvas.png]]
### Light/dark mode = ✅
...
![[images/Simens skjermbilder 20-12-2022- kl 07.19.29.gif|images/Simens skjermbilder 20-12-2022- kl 07.19.29.gif]]
...
Men det er mer.. Og her må vi dele det opp i de mer opplagte grunnene, og de mer overraskende grunnene til hvorfor jeg virkelig har begynt å like [[obsidian|obsidian]].
...
Det gjør det ikke bare uendelig mye lettere å skrive nye artikler, men det gjør det morsommere å lese, siden jeg har et system for å kunne anvende det seinere. For selve måten [[obsidian|obsidian]] er satt sammen på så oppfordrer hele systemet til at du skal tenke tydeligere. Trekke unike koblinger mellom det du har tenkt på tidligere, og skrive egne tanker basert på det.
...
I tillegg til [Discorden](https://obsidian.md/community?ref=simen-skriver) til [[obsidian|obsidian]], som er _vanvittig aktiv_, med hele 81 000 medlemmer! I tillegg til at du har egne "sub-communities" som f. eks en plugin som heter [Make.md](https://www.make.md/?ref=simen-skriver), som igjen har nærmere 1000 folk på Discorden sin.

![[images/obsidian-community.png|images/obsidian-community.png]]

### Plugins

Ikke bare kommer det jevnlige oppdateringer fra [[obsidian|obsidian]] jevnt og trutt, men det er også [haugevis av plugins](https://obsidian.md/plugins?ref=simen-skriver) som andre folk har lagd. Faktisk så er det 753 av dem for øyeblikket, og det blir flere for hver dag. 754 faktisk, for det dukka opp enda en i løpet av tida jeg brukte på å skrive det her.

Grunnen til at det er så bra er at det lar deg tilpasse programmet akkurat sånn du vil. For det er alltid noen som har hatt ønske om å gjøre det samme som deg. Eller så finnes det en måte å jobbe seg rundt det på. Så det vil si at enhver liten "shortcoming" fra [[obsidian|obsidian]] sin side, vil som regel kunne løses av det som lages av folka som bruker det 🤯
...
Så hvis jeg ville bytta til [Craft](https://www.craft.do/?ref=simen-skriver) f. eks kunne jeg importert den samma mappa med tekstfiler, som jeg bruker til [[obsidian|obsidian]] uten noe mer trøbbel enn som så. 

![[images/craft-note.png|images/craft-note.png]]
<figcaption>Samme notat i Craft</figcaption>

![[images/ia-writer-note.png|images/ia-writer-note.png]]
